                    ...
                    contacts.convo.map(mess =>
                      <div key={mess._id}>
                        ...
                        {userName === mess.person &&
                          <div ref={refer} className="messageContent" style={{ marginRight: "12px", backgroundColor: 'goldenrod', width: 'fit-content', marginBottom: '-58px', float: 'right', height: "38px" }}><h1>{mess.personConvo}</h1>
                          </div>
                        }
                        {userName !== mess.person &&
                          <div ref={refer} className="messageContent" style={{ marginLeft: "8px", backgroundColor: 'goldenrod', width: 'fit-content', marginBottom: '-58px', float: 'left', height: "38px" }}><h1>{mess.personConvo}</h1>
                          </div>
                        }
